...
Route::prefix('cetak')->group(function () {
    ...
    Route::post('/lulus-sempro', [CetakController::class, 'cetak_lulusSempro'])->middleware('koordinator');
    Route::post('/lulus-kompre', [CetakController::class, 'cetak_lulusKompre'])->middleware('koordinator');
