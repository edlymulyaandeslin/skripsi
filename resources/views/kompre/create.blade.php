        ...
        <div class="col-md-12">
            ...
            @elseif ($kompre->count() != 0)
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('kompre.update', $kompre[0]->id) }}" method="post"
            ...
            @else
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('kompre.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-floating mb-3">
                            <select class="form-select @error('judul_id') is-invalid @enderror" id="form-file"
                                name="judul_id">
