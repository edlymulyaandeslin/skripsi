            ...
            <div class="row">
                    ...
                    <table id="table" class="table text-center">
                        ...
                        <tbody id="tbody">
                            ...
                            <tr>
                                ...
                                <td>{{ ($nilaipem1 + $nilaipem2 + $nilaipeng1 + $nilaipeng2 + $nilaipeng3) / 5 }}</td>
                                <td></td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="col-md-6 offset-7">
                    ...
                    <div>
                        ...
                        <p class="m-0">{{ $admin[0]->name ?? '-' }}</p>
                        <p class="m-0">NIDN. {{ $admin[0]->nim_or_nidn }}</p>
                    </div>
                </div>
                    ...
                    <table id="table" class="table">
                        ...
                        <tbody id="tbody" class="p-4">
                            <tr>
                                ...
                                <td>0 - 15</td>
                                <td>{{ $nilai1 = $sempro->nilaisempro->nilai1_pem1 }}</td>
                            </tr>
                            <tr>
                                ...
                                <td>0 - 15</td>
                                <td>{{ $nilai2 = $sempro->nilaisempro->nilai2_pem1 }}</td>
                            </tr>
                            <tr>
                                <td rowspan="2">Studi Literatur</td>
                                <td>Ide/gagasan/strategi untuk menyelesaikan masalah</td>
                                <td>0 - 10</td>
                                <td>{{ $nilai3 = $sempro->nilaisempro->nilai3_pem1 }}</td>
                            </tr>
                            <tr>
                                <td>Justifikasi pemilihan model/ metode/ teori baik model simulasi, komputasi atau model
                                    pembangunan aplikasi/perangkat lunak dengan melakukan studi literatur</td>
                                <td>0 - 10</td>
                                <td>{{ $nilai4 = $sempro->nilaisempro->nilai4_pem1 }}</td>
                            </tr>
                            <tr>
                                ...
                                <td>0 - 10</td>
                                <td>{{ $nilai5 = $sempro->nilaisempro->nilai5_pem1 }}</td>
                            </tr>
                            <tr>
                                <td rowspan="2">Expert Judgement</td>
                                <td colspan="2">Kemandirian mahasiswa dalam penyusunan proposal</td>
                                <td>0 - 20</td>
                                <td>{{ $nilai6 = $sempro->nilaisempro->nilai6_pem1 }}</td>
                            </tr>
                            <tr>
                                <td colspan="2">Proses Bimbingan</td>
                                <td>0 - 20</td>
                                <td>{{ $nilai7 = $sempro->nilaisempro->nilai7_pem1 }}</td>
                            </tr>
                            <tr>
                        ...
                        <tbody id="tbody" class="p-4">
                            <tr>
                                ...
                                <td>Kemampuan memilih dan menjustifikasi Tema yang akan diangkat dari sisi Latar
                                    Belakang dan Rumusan Masalah</td>
                                <td>0 - 15</td>
                                <td>{{ $nilai1 = $sempro->nilaisempro->nilai1_pem2 }}</td>
                            </tr>
                            <tr>
                                <td>Pertanyaan Penelitian</td>
                                <td>Cara menyajikan pertanyaan penelitian/problem statement untuk membangun Rumusan
                                    Masalah dan Tujuan</td>
                                <td>0 - 15</td>
                                <td>{{ $nilai2 = $sempro->nilaisempro->nilai2_pem2 }}</td>
                            </tr>
                            <tr>
                                <td rowspan="2">Studi Literatur</td>
                                <td>Ide/gagasan/strategi untuk menyelesaikan masalah</td>
                                <td>0 - 10</td>
                                <td>{{ $nilai3 = $sempro->nilaisempro->nilai3_pem2 }}</td>
                            </tr>
                            <tr>
                                <td>Justifikasi pemilihan model/ metode/ teori baik model simulasi, komputasi atau model
                                    pembangunan aplikasi/perangkat lunak dengan melakukan studi literatur</td>
                                <td>0 - 10</td>
                                <td>{{ $nilai4 = $sempro->nilaisempro->nilai4_pem2 }}</td>
                            </tr>
                            <tr>
                                <td>Rencana Implementasi Simulasi/Komputasi</td>
                                <td>Penjelasan tentang bagaimana membangun Implementasi/ Simulasi/ Komputasi yang
                                    diturunkan dari pemodelan</td>
                                <td>0 - 10</td>
                                <td>{{ $nilai5 = $sempro->nilaisempro->nilai5_pem2 }}</td>
                            </tr>
                            <tr>
                                <td rowspan="2">Expert Judgement</td>
                                <td colspan="2">Kemandirian mahasiswa dalam penyusunan proposal</td>
                                <td>0 - 20</td>
                                <td>{{ $nilai6 = $sempro->nilaisempro->nilai6_pem2 }}</td>
                            </tr>
                            <tr>
                                <td colspan="2">Proses Bimbingan</td>
                                <td>0 - 20</td>
                                <td>{{ $nilai7 = $sempro->nilaisempro->nilai7_pem2 }}</td>
                            </tr>
                            <tr>
                                <th colspan="3">Jumlah</th>
                                <td>0 - 100</td>
                    ...
                    <table id="table" class="table">
                        ...
                        <tbody id="tbody" class="p-4">
                            <tr>
                                ...
                                <td>0 - 25</td>
                                <td>{{ $nilai1 = $sempro->nilaisempro->nilai1_peng1 }}</td>
                            </tr>
                            <tr>
                                <td>Menguasai teori pendukung TA</td>
                                <td>0 - 15</td>
                                <td>{{ $nilai2 = $sempro->nilaisempro->nilai2_peng1 }}</td>
                            </tr>
                            <tr>
                                <td>Menguasai materi terkait dengan tools pemodelan, simulasi ataupun implementasi</td>
                                <td>0 - 25</td>
                                <td>{{ $nilai3 = $sempro->nilaisempro->nilai3_peng1 }}</td>
                            </tr>
                            <tr>
                                <td rowspan="2">Expert Judgement</td>
                                <td>Pemaparan/cara menjawab</td>
                                <td>0 - 25</td>
                                <td>{{ $nilai4 = $sempro->nilaisempro->nilai4_peng1 }}</td>
                            </tr>
                            <tr>
                                <td>Komunikasi interpersonal</td>
                                <td>0 - 25</td>
                                <td>{{ $nilai5 = $sempro->nilaisempro->nilai5_peng1 }}</td>
                            </tr>
                            <tr>
                        ...
                        <tbody id="tbody" class="p-4">
                            <tr>
                                ...
                                <td>Menjawab latar belakang permasalahan, perumusan masalah, tujuan dan metodologi
                                    secara terstruktur</td>
                                <td>0 - 25</td>
                                <td>{{ $nilai1 = $sempro->nilaisempro->nilai1_peng2 }}</td>
                            </tr>
                            <tr>
                                <td>Menguasai teori pendukung TA</td>
                                <td>0 - 15</td>
                                <td>{{ $nilai2 = $sempro->nilaisempro->nilai2_peng2 }}</td>
                            </tr>
                            <tr>
                                <td>Menguasai materi terkait dengan tools pemodelan, simulasi ataupun implementasi</td>
                                <td>0 - 25</td>
                                <td>{{ $nilai3 = $sempro->nilaisempro->nilai3_peng2 }}</td>
                            </tr>
                            <tr>
                                <td rowspan="2">Expert Judgement</td>
                                <td>Pemaparan/cara menjawab</td>
                                <td>0 - 25</td>
                                <td>{{ $nilai4 = $sempro->nilaisempro->nilai4_peng2 }}</td>
                            </tr>
                            <tr>
                                <td>Komunikasi interpersonal</td>
                                <td>0 - 25</td>
                                <td>{{ $nilai5 = $sempro->nilaisempro->nilai5_peng2 }}</td>
                            </tr>
                            <tr>
                                <th colspan="2">Jumlah</th>
                                <td>0 - 100</td>
                        ...
                        <tbody id="tbody" class="p-4">
                            <tr>
                                ...
                                <td>Menjawab latar belakang permasalahan, perumusan masalah, tujuan dan metodologi
                                    secara terstruktur</td>
                                <td>0 - 25</td>
                                <td>{{ $nilai1 = $sempro->nilaisempro->nilai1_peng3 }}</td>
                            </tr>
                            <tr>
                                <td>Menguasai teori pendukung TA</td>
                                <td>0 - 15</td>
                                <td>{{ $nilai2 = $sempro->nilaisempro->nilai2_peng3 }}</td>
                            </tr>
                            <tr>
                                <td>Menguasai materi terkait dengan tools pemodelan, simulasi ataupun implementasi</td>
                                <td>0 - 25</td>
                                <td>{{ $nilai3 = $sempro->nilaisempro->nilai3_peng3 }}</td>
                            </tr>
                            <tr>
                                <td rowspan="2">Expert Judgement</td>
                                <td>Pemaparan/cara menjawab</td>
                                <td>0 - 25</td>
                                <td>{{ $nilai4 = $sempro->nilaisempro->nilai4_peng3 }}</td>
                            </tr>
                            <tr>
                                <td>Komunikasi interpersonal</td>
                                <td>0 - 25</td>
                                <td>{{ $nilai5 = $sempro->nilaisempro->nilai5_peng3 }}</td>
                            </tr>
                            <tr>
                                <th colspan="2">Jumlah</th>
                                <td>0 - 100</td>
